...
local objects = {}
local themes = {
	Background = Color3.fromRGB(12,2,9), 
	Glow = Color3.fromRGB(151,28,255), 
	Accent = Color3.fromRGB(8,4,19), 
	LightContrast = Color3.fromRGB(11,4,19), 
	DarkContrast = Color3.fromRGB(17,4,27),  
